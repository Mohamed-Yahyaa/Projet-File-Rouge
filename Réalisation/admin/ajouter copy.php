...
if(!empty($_POST)){
	...
	$deviis->setId_favoris($_POST['id_favoris']);
	$deviis->setId_hotels($_POST['id_hotels']);
                                             ...
                                             <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group ">
                                                        ...
                                                        <input id="cc-exp" name="id_hotels" type="text" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration"
